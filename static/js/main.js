const menuData = {
  categories: [
    ...
    },
    {
      ...
      icon: "🧊",
      items: [
        { name: "آیس لته", price: 140 },
        { name: "آیس لته فندقی", price: 160 },
        { name: "آیس کارامل ماکیاتو", price: 160 },
        { name: "آیس موکا", price: 160 },
        { name: "آیس آمریکانو", price: 115 },
        { name: "آیس چاکلت", price: 170 },
        { name: "آیس ماچا لته", price: 185 },
        { name: "ماچابری", price: 250 },
        { name: "آیس اسپرولینا", price: 170 },
        { name: "خلیج", desc: "اسپرولینا، انبه، یخ‌شیر", price: 260 },
      ],
    },
    {
      title: "شیک",
      icon: "🥤",
      items: [
        { name: "موز شکلات", price: 230 },
        { name: "انبه (با تکه‌های میوه)", price: 260, badge: "جدید" },
        { name: "توت فرنگی", price: 220 },
        { name: "لوتوس", price: 220 },
        { name: "کره گردو", price: 220 },
        { name: "گیان", price: 220 },
        { name: "شیک پروتئینی", desc: "شیر، عسل، کره بادام زمینی", price: 290 },
      ],
    },
    {
      title: "ماکتل",
      icon: "🍹",
      items: [
        { name: "گیان", desc: "عطری و گازدار", price: 195 },
        { name: "زرین", desc: "استوایی و لیمویی", price: 195 },
        { name: "رعنا", desc: "ترش و تند", price: 195 },
        { name: "نیل", desc: "شیرین و عطری", price: 195 },
      ],
    },
    {
      title: "ژلاتو",
      icon: "🍨",
      items: [
        { name: "آفوگاتو", desc: "وانیل، شکلات", price: 180 },
        { name: "استوایی", desc: "موز، آناناس، انبه، پسته", price: 330 },
      ],
    },
    {
      title: "بستنی",
    ...
    },
    {
      ...
      icon: "🥐",
      items: [
        { name: "کروسان پسته", price: 285 },
        { name: "کروسان شکلات", price: 270 },
        { name: "کروسان لوتوس", price: 285 },
        { name: "رول نیویورکی پسته", price: 285 },
        { name: "رول نیویورکی شکلات", price: 270 },
        { name: "رول نیویورکی لوتوس", price: 285 },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "چیزکیک روز", price: 175 },
        { name: "دبی چاکلت", price: 180 },
