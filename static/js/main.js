  ...
  categories: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "شیر عسل", price: 120 },
        { name: "ماسالا", price: 120 },
        { name: "وایت چاکلت", price: 120 },
        { name: "شیرکاکائو", price: 120 },
        { name: "ماچا لته", price: 140 },
        { name: "اسپرولینا", price: 140 },
        { name: "چای کرک", price: 120 },
      ],
    },
    {
      title: "دمنوش",
    ...
    },
    {
      ...
      icon: "🧊",
      items: [
        { name: "آیس لته", price: 120 },
        { name: "آیس لته فندقی", price: 140 },
        { name: "آیس کارامل ماکیاتو", price: 140 },
        { name: "آیس موکا", price: 140 },
        { name: "آیس آمریکانو", price: 115 },
        { name: "آیس چاکلت", price: 145 },
    ...
    },
    {
      ...
      icon: "🥐",
      items: [
        { name: "کروسان پسته", price: 250 },
        { name: "کروسان شکلات", price: 230 },
        { name: "کروسان لوتوس", price: 250 },
        { name: "رول نیویورکی پسته", price: 255 },
        { name: "رول نیویورکی شکلات", price: 230 },
        { name: "رول نیویورکی لوتوس", price: 235 },
    ...
    },
    {
      ...
      items: [
        { name: "کیک خیس شکلاتی", price: 120 },
        { name: "تیرامیسو", price: 140, badge: "پرفروش" },
        { name: "کیک سه شیر", price: 140 },
        { name: "چیزکیک روز", price: 145 },
        { name: "دبی چاکلت", price: 160 },
        { name: "چیزکیک پسته", price: 260 },
      ],
    },
    {
